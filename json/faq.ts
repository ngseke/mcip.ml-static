...
export const faq = [
  ...
  },
  {
    ...
    content: [
      {
        question: '繳費後過多久才會收到確認通知',
        answer: '繳費完成後會在一個工作天內收到樂台計畫 LINE 官方帳號的推播訊息哦！',
      },
      {
  ...
  },
  {
    ...
    content: [
      {
        question: '平台退費資格',
        answer: '必須透過金流服務完成繳費，以及在該賽事報名截止前透過系統辦理退賽者才符合退費資格。',
      },
      {
        question: '我已透過平台繳費，但退賽後如何辦理退費呢？',
        answer: '在報名截止前辦理退賽，您會收到 50% 報名金額並扣除 $15 跨行手續費用的退費款項 (除高科大弦音盃、流音之星、淡江金韶獎)。\n報名截止後則不予退費。\n\n註1：流音之星、淡江金韶獎規章規定不予退費。\n註2：高科大弦音盃規章規定報名截止後不予退費。\n註3：政大金旋獎因賽制規章規定，有關退費與棄賽之條約內容，由政大金旋獎自行處理，系統不需作出任何保證或承擔任何責任。',
      },
      {
        question: '何時能收到退費呢？',
        answer: '該院校賽事報名截止後 3-14 個工作天內會收到退費以及 LINE 官方帳號的推播訊息。',
      },
    ],
  },
